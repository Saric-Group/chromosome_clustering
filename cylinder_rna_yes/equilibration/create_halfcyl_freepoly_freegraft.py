...
natoms= natoms_surf + natoms_grafted_poly + npoly_free*polymer_length_free + npoly_free_graft*polymer_length
nbonds= natoms_grafted_poly + npoly_free*(polymer_length_free-1) + npoly_free_graft*(polymer_length-1)
nangles= n_grafted_poly*(polymer_length-1) + npoly_free*(polymer_length_free-2) + npoly_free_graft*(polymer_length-2)

with open('halfcyl_freepoly_freegraft_ngraft%d_nlayers%d_npolyfreegraft%d_npolyfree%d_Npolyfree%d.lammpsdata'%(n_graft,n_grafted_layers,npoly_free_graft,npoly_free,polymer_length_free),'w') as fout:
